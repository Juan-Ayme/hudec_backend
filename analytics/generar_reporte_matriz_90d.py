#!/usr/bin/env python3
"""
Generador de reporte Excel — Módulo 04: Matriz 90d (snapshot del ahora)
=====================================================================
Lee el SQL 'matriz_kawii_90d.sql' y produce un Excel con portada,
datos coloreados por clasificación y resumen.

Uso: python generar_reporte.py
Salida: ../reportes_excel/[fecha]/04_Matriz_90d.xlsx
"""
import sys
import psycopg2
...
MODULO_ID = '04'
TITULO = 'Matriz 90d — snapshot del ahora'
# Nombre del SQL (solo para mostrar en la portada del Excel)
SQL_FILE = '04_matriz_90d.sql'
# Path relativo desde analytics/ al SQL del backend (única fuente de verdad)
SQL_PATH = '../app/kawii_matrix/sql/04_matriz_90d.sql'
DESCRIPCION = ('Foto pura de los últimos 90 días sin contexto histórico. '
               'Solo SKUs activos (con stock, ventas o recepciones recientes). '
               'Útil para decisiones diarias.')
